...
export const toolDefinitions: ChatCompletionTool[] = [
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          icon: {
            type: 'string',
            description: 'Optional emoji icon, e.g. "üçî"',
          },
        },
        required: ['name'],
      },
  ...
  // ============ BILLS ============
  {
    ...
    function: {
      name: 'create_bill',
      description:
        'Create a bill (one-time or recurring expense/income template). Use when the user wants to schedule a future expense like rent, subscriptions, or a one-off payment. Does NOT immediately create a transaction ó call generate_bill to post the actual entry.',
      parameters: {
        type: 'object',
        properties: {
          type: {
