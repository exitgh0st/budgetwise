...
## Purpose
AI financial advisor. Wraps DeepSeek V3, exposes 32 tools, runs input/output guardrails, and gates destructive actions behind explicit confirmation.
...
| File | Role |
|------|------|
| `chat.module.ts` | Imports Accounts/Categories/Transactions/ScheduledTransactions/Budgets/Reports modules for `ToolExecutor` |
...
## Relations
- Imports services from [[accounts]], [[categories]], [[transactions]], [[scheduled-transactions]], [[budgets]], [[reports]]
...
- Goal management still has no chat tools; it remains UI/API driven.
